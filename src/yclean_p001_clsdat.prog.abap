...
SELECTION-SCREEN BEGIN OF BLOCK b1 WITH FRAME TITLE TEXT-s01.
  ...
  SELECTION-SCREEN BEGIN OF LINE.
    ...
    PARAMETERS: p_rb2a RADIOBUTTON GROUP gr2 DEFAULT 'X' USER-COMMAND cmd2 MODIF ID rd2.
    SELECTION-SCREEN COMMENT (30) TEXT-p01 FOR FIELD p_rb2a MODIF ID rd2.
  SELECTION-SCREEN END OF LINE.
  SELECTION-SCREEN BEGIN OF LINE.
    SELECTION-SCREEN POSITION 4.
    PARAMETERS: p_rb2b RADIOBUTTON GROUP gr2 MODIF ID rd2.
    SELECTION-SCREEN COMMENT (30) TEXT-p02 FOR FIELD p_rb2b MODIF ID rd2.
  SELECTION-SCREEN END OF LINE.
  PARAMETERS:
...
SELECTION-SCREEN BEGIN OF BLOCK b2 WITH FRAME TITLE TEXT-s02.
  PARAMETERS:
    p_rldnr TYPE rldnr AS LISTBOX VISIBLE LENGTH 6 DEFAULT 'ML' OBLIGATORY MODIF ID md1,
    p_bukrs TYPE bukrs DEFAULT '1001' MODIF ID md2,
    p_gjahr TYPE gjahr DEFAULT sy-datum(4) MODIF ID md3,
    p_monat TYPE monat DEFAULT '01' MODIF ID md4,
    p_bstat TYPE bstat_d DEFAULT 'L' MODIF ID md5.
  SELECT-OPTIONS:
   s_afabe FOR t093-afaber NO INTERVALS MODIF ID md6,
   s_belnr FOR acdoca-belnr NO INTERVALS MODIF ID md7.
...
CLASS application IMPLEMENTATION .
  ...
  METHOD at_selection_screen_output.
    ...
    LOOP AT SCREEN.
      ...
      CASE abap_true.
        WHEN p_rb1.
          IF screen-group1 EQ 'MD2' OR screen-group1 EQ 'MD5' OR screen-group1 EQ 'MD7'.
            screen-active = 1.
  ...
  METHOD listbox_build.
    ...
    FREE: _values, _id.
    _id = 'P_PRLL'.
    _values = VALUE #( BASE _values ( key = '01' ) ( key = '02' ) ( key = '04' ) ( key = '06' ) ( key = '08' ) ( key = '10' ) ).
