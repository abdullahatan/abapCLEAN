...
*                                         IN ( SELECT Session_context( 'CLIENT' ), bukrs, anln1, anln2, gjahr, awtyp, awref, aworg, awsys, subta, afabe, slalittype, drcrk FROM :t_result );
        ...
        SELECT COUNT (*) FROM faat_doc_it WHERE( mandt, bukrs, anln1, anln2, gjahr, awtyp, awref, aworg, awsys, subta, afabe, slalittype, drcrk )
                                             IN ( SELECT Session_context( 'CLIENT' ), bukrs, anln1, anln2, gjahr, awtyp, awref, aworg, awsys, subta, afabe, slalittype, drcrk FROM :t_result );
        IF numberofentities = 0.
        THEN
            ev_subrc = 0;
...
*                                       IN ( SELECT Session_context( 'CLIENT' ), bukrs, anln1, anln2, gjahr, afabe FROM :t_result );
        ...
        SELECT COUNT (*) FROM faat_ydda WHERE( mandt, bukrs, anln1, anln2, gjahr, afabe )
                                           IN ( SELECT Session_context( 'CLIENT' ), bukrs, anln1, anln2, gjahr, afabe FROM :t_result );
        IF numberofentities = 0.
        THEN
            ev_subrc = 0;
...
*                                              IN ( SELECT Session_context( 'CLIENT' ), bukrs, anln1, anln2, gjahr, afabe, poper, slalittype FROM :t_result );
        ...
        SELECT COUNT (*) FROM faat_plan_values WHERE( mandt, bukrs, anln1, anln2, gjahr, afabe, poper, slalittype )
                                                  IN ( SELECT Session_context( 'CLIENT' ), bukrs, anln1, anln2, gjahr, afabe, poper, slalittype FROM :t_result );
        IF numberofentities = 0.
        THEN
            ev_subrc = 0;
...
*                                  IN ( SELECT Session_context( 'CLIENT' ), bukrs, anln1, anln2, afabe, bdatu FROM :t_result );
        ...
        SELECT COUNT (*) FROM anlb WHERE( mandt, bukrs, anln1, anln2, afabe, bdatu )
                                      IN ( SELECT Session_context( 'CLIENT' ), bukrs, anln1, anln2, afabe, bdatu FROM :t_result );
        IF numberofentities = 0.
        THEN
            ev_subrc = 0;
